...
<main class="container-xxl">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 order-1 order-sm-2">
                    <img style="border-radius: 50%; object-fit: cover; height :400px; width : 400px;" src=" https://cdn.romania-insider.com/sites/default/files/styles/article_large_image/public/2022-03/blood_donation_help_-_photo_korn_vitthayanukarun_dreamstime.com_.jpg" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="table-section">
        <h2 class="table-sec-title fw-bold display-5">Available Doners</h2>
